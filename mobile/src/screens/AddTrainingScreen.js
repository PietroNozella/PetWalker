...
export default function AddTrainingScreen() {
  ...
  const handleSave = async () => {
    if (!form.dog_id || !form.training_type) {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.form}>
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>Tipo de Adestramento *</Text>
          <View style={styles.pickerContainer}>
            <Picker
              selectedValue={form.training_type}
              onValueChange={(value) => setForm({ ...form, training_type: value })}
              style={styles.picker}
              dropdownIconColor={colors.text}
            >
              <Picker.Item label="Selecione o tipo..." value="" color={colors.textMuted} />
