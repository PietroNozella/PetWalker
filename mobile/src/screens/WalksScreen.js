    ...
    Alert.alert(
      ...
      [
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await api.delete(`/api/walks/${walk.id}`);
              loadData();
            } catch (error) {
    ...
    <View style={styles.card}>
      ...
      <View style={styles.cardDetails}>
        ...
        <View style={styles.detailItem}>
          ...
          <Text style={styles.detailText}>{item.location || 'Local não informado'}</Text>
        </View>
      </View>
      ...
      <View style={styles.cardActions}>
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('EditWalk', { walk: item })}
        >
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={styles.emptyText}>Nenhum passeio agendado</Text>
          </View>
        }
      />
    </View>
